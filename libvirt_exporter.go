...
func NewLibvirtExporter(uri string, exportNovaMetadata bool) (*LibvirtExporter, error) {
	...
	return &LibvirtExporter{
		...
		libvirtDomainMemSwapInDesc: prometheus.NewDesc(
			prometheus.BuildFQName("libvirt", "domain_memory_stats", "swap_in_memory"),
			"The amount of data read from swap space.",
			domainLabels,
			nil),
		libvirtDomainMemSwapOutDesc: prometheus.NewDesc(
			prometheus.BuildFQName("libvirt", "domain_memory_stats", "swap_out_memory"),
			"The amount of memory written out to swap space.",
			domainLabels,
			nil),
		libvirtDomainMemRssDesc: prometheus.NewDesc(
			prometheus.BuildFQName("libvirt", "domain_memory_stats", "rss_memory"),
